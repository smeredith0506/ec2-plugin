...
public final class EC2OndemandSlave extends EC2AbstractSlave {
    ...
    public EC2OndemandSlave(String instanceId, String description, String remoteFS, int sshPort, int numExecutors,
                            String labelString, Mode mode, String initScript, String remoteAdmin, String rootCommandPrefix,
                            String jvmopts, boolean stopOnTerminate, String idleTerminationMinutes, String publicDNS,
                            String privateDNS, List<EC2Tag> tags, String cloudName)
        ...
        this(description + " (" + instanceId + ")", instanceId, description, remoteFS, sshPort, numExecutors, labelString,
                ...
                idleTerminationMinutes, publicDNS, privateDNS, tags, cloudName, false);
    }

    public EC2OndemandSlave(String instanceId, String description, String remoteFS, int sshPort, int numExecutors, String labelString,
        ...
        this(description + " (" + instanceId + ")", instanceId, description, remoteFS, sshPort, numExecutors, labelString,
                Mode.NORMAL, initScript, Collections.<NodeProperty<?>>emptyList(), remoteAdmin, rootCommandPrefix, jvmopts, stopOnTerminate,
                idleTerminationMinutes, publicDNS, privateDNS, tags, cloudName, usePrivateDnsName);
    }

    @DataBoundConstructor
    public EC2OndemandSlave(String name, String instanceId, String description, String remoteFS, int sshPort, int numExecutors,
                            ...
                            String idleTerminationMinutes, String publicDNS, String privateDNS, List<EC2Tag> tags,
                            String cloudName, boolean usePrivateDnsName)
            throws FormException, IOException {
